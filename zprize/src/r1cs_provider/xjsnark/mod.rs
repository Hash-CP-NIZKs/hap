...
pub fn build_r1cs_for_verify_ecdsa(
    ...
    let output = Command::new("/usr/lib/jvm/java-8-openjdk/bin/java")
        .args([
            "-cp",
            "/home/imlk/workspace/zprize/zprize_demo/out/production/zprize_demo/:/home/imlk/workspace/zprize/xjsnark/languages/xjsnark/runtime/lib/xjsnark_backend.jar",
    ...
    // Example:
    // /home/imlk/workspace/zprize/jsnark/libsnark/build/libsnark/jsnark_interface/arith_to_r1cs /tmp/VerifyEcdsa.arith /tmp/VerifyEcdsa_Sample_Run1.in
